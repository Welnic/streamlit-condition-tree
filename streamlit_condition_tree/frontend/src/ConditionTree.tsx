...
class ConditionTree extends StreamlitComponentBase<State> {
  private debouncedSetStreamlitValue: _.DebouncedFunc<
    (tree: ImmutableTree) => void
  >
  ...
  public constructor(props: ComponentProps) {
    ...
    // Create a more aggressive debounce to reduce updates
    this.debouncedSetStreamlitValue = _.debounce(this.setStreamlitValue, 500)
  }
  ...
  componentDidUpdate() {
    // Get previous state from current state since we can't access prevState
    ...
    // Handle expanded state and height updates
